return {
  ...
  config = function(_, opts)
    ...
    local function apply_untracked_git_status_highlight()
      -- Link to Normal so untracked entries keep its readable foreground without a picker-specific background.
  ...
  keys = {
    ...
    -- LSP (picker-based, overrides built-in)
    ...
    -- Lua debug
    { "<localleader>r", function() Snacks.debug.run() end, desc = "Run Lua", mode = { "n", "x" } },
  },
  init = function()
